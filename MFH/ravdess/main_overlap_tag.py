...
if __name__ == '__main__':
    ...
    loader = gen_data('/home/ducca/CMKD/MFH/ravdess/data/ravvdess', args.batch_size, args.num_workers)
    if args.cal_tag:
        loader_fb = gen_data('/home/ducca/CMKD/MFH/ravdess/data/ravvdess', args.batch_size2, args.num_workers)
