...
class VGGSound_dataset(object):
    def __init__(self, path_to_dataset=r'/workdir/carrot/VGGSound/scratch/shared/beegfs/hchen/train_data/VGGSound_final/video', frame_interval=1, frame_kept_per_second=1):
        self.path_to_video = path_to_dataset
        self.path_to_audio = os.path.join('/workdir/carrot/VGGSound', 'Audios')
        self.frame_kept_per_second = frame_kept_per_second
        self.sr = 16000

        self.path_to_save = os.path.join("/home/ducca/CMKD/C2KD/vggsound/utils/data/VGGSound_dataset", 'Image-{:02d}-FPS-SE'.format(self.frame_kept_per_second))
        if not os.path.exists(self.path_to_save):
            os.mkdir(self.path_to_save)

        self.path_to_save_audio = os.path.join("/home/ducca/CMKD/C2KD/vggsound/utils/data/VGGSound_dataset", 'Audio-{:d}-SE'.format(1004))
        ...
        csv_path = '/home/ducca/CMKD/C2KD/vggsound/utils/data/VGGSound/vggsound.csv'
