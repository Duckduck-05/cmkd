...
CUDA_VISIBLE_DEVICES=2 python main_overlap_tag.py --gpu 0 --batch-size 64 --stu-type 0 --distill_type 1 &

# Đợi 1 phút (60 giây) rồi chạy job 2
sleep 60
CUDA_VISIBLE_DEVICES=3 python main_overlap_tag.py --gpu 0 --batch-size 64 --stu-type 1 --distill_type 1 &
