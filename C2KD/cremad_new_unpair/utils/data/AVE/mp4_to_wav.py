...
all_videos = r'/home/ducca/CMKD/C2KD/ave_new/utils/data/AVE_Dataset/Annotations.txt'
all_audio_dir = r'/home/ducca/CMKD/C2KD/ave_new/utils/data/AVE_Dataset/Audios'
...
for i, item in enumerate(files[1:]):
    if i % 500 == 0:
        ...
        print('*******************************************')
    item = item.split('&')
    mp4_filename = os.path.join(r'/home/ducca/CMKD/C2KD/ave_new/utils/data/AVE_Dataset/AVE', item[1] + '.mp4')
