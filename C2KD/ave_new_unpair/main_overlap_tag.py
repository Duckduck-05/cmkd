...
import random
import wandb
from utils.helper import gen_data, train_network_distill, train_network_distill_unpair, pre_train
...
def eval_overlap_tag(loader, device, args):
    ...
    acc = train_network_distill_unpair(stu_type, tea_model, args.num_epochs, loader, net, device, optimizer2, warmup_lr_scheduler, main_lr_scheduler, lr_scheduler, args, tea, stu)
    return acc
...
if __name__ == '__main__':
    ...
    wandb.init(entity= "cmkd" ,project="baseline",
                name=f"data: ave, type:unpair, lr_{args.lr}_bs_{args.batch_size}_numepochs_{args.num_epochs}_stutype_{args.stu_type}",
